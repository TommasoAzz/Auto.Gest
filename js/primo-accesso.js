    ...
    $.post("/accesso/script/convalidaRegistrazione.php", datiRegistrazione, function(result) {
        ...
        switch(result) {
            case "errore_db_corrispondenza_nome_cognome_password":
                ...
                break;
            case "errore_db_username_esistenti":
                $alert(
                    "Operazione non effettuata",
                    "L'username inserito è già presente nel database. Controlla i dati inseriti."
                );
                break;  
            ...
            case "profilo_creato":
                $alert(
                    ...
                    "Profilo creato con successo. Puoi ora accedere con il nome utente e la password che hai appena creato."
                );
